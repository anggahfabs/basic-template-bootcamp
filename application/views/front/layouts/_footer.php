      ...
      <div class="row f_widgets_inner">
         <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="single-footer-widget ab_widgets">
               <div class="f_title">
                  <h3>elevensports.com</h3>
               </div>
               <p>ElevenSports merupakan portal berita bola kekinian yang menyediakan berbagai macam berita seputar sepak bola </p>
            </div>
         </div>
         <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="single-footer-widget">
                  <div class="f_title">
                  <h3>Kategori Dan Info</h3>
                  </div>
                  <div class="row">
                     <div class="col-6">
                     ...
                     <div class="col-6">
                        ...
                        <ul class="list">
                              <li><a href="<?= base_url('contact') ?>">Tentang Kita</a></li>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | ElevenSport 
